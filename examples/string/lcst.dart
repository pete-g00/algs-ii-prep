import 'package:classes/string.dart' show tableLCSt, rowLCSt;
...
void main(List<String> args) {
  ...
  // find the longest common substring between two texts (using the table DP algorithm)
  print(tableLCSt(text1, text2));
  // find the longest common substring between two texts (using the row DP algorithm)
  print(rowLCSt(text1, text2));
}
