import 'package:classes/string.dart' show tableLCSq, tracebackLCSq, rowLCSq, tableMemoisedLCSq, spaceMemoisedLCSq;
...
void main(List<String> args) {
  ...
  // find the length of the longest common subsequence between two texts (using the table DP algorithm)
  print(tableLCSq(text1, text2));
  // find the length of the longest common subsequence between two texts (using the row DP algorithm)
  print(rowLCSq(text1, text2));
  // find the longest common subsequence between two texts (using the table DP algorithm with traceback)
  print(tracebackLCSq(text1, text2));
  // find the longest common subsequence between two texts (memoised)
  print(tableMemoisedLCSq(text1, text2));
  // find the longest common subsequence between two texts (memoised, space optimised)
  print(spaceMemoisedLCSq(text1, text2));
}
